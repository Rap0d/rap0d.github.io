...
> 예제 파일 : [R정형데이터처리하기.xlsx]({{"/assets/file/r/191011/R정형데이터처리하기.xlsx" | absolute_url}})  
> 예제 파일 : [jumsu.csv]({{"/assets/file/r/191011/jumsu.csv" | absolute_url}})  
> 예제 파일 : [2013년_프로야구선수_성적.csv]({{"/assets/file/r/191011/2013년_프로야구선수_성적.csv" | absolute_url}})  
